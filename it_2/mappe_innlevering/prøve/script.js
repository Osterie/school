...
function winInit() {
  ...
  elGetId("gjennomsnitt").addEventListener("click", function(event){ plot_graf(måneder, gjennomsnitt_temp, "Måneder", "Gjennomsnitt Temperatur", "Tafjord [SN60500]") })
  elGetId("differanse").addEventListener("click", function(event){ plot_graf(måneder, differanse_temp, "Måneder", "Temperatur forskjell", "Tafjord [SN60500]") })
  elGetId("søyle_maks").addEventListener("click", function(event){ plot_søyle_diagram(måneder, maks_temp, "Tafjord [SN60500]", "Måned", "Temperatur", "Tafjord [SN60500]") })
  elGetId("søyle_min").addEventListener("click", function(event){ plot_søyle_diagram(måneder, min_temp, "Tafjord [SN60500]", "Måned", "Temperatur", "Tafjord [SN60500]") });
...
function oppstart() {
  ...
  plot(måneder, maks_temp, "rød", "Maks temp", "Tafjord [SN60500]");
  plot(måneder, min_temp, "svart", "Min temp", "Tafjord [SN60500]");
...
function plot_graf(x_liste, y_liste, x_akse, y_akse, tittel) {
  tegnBrukBakgrunn("white");
  plot(x_liste, y_liste, "blå", y_akse, tittel);
...
function plot(xliste, yliste, graf_farge, tekst, tittel) {
  tegnTittel(tittel, "svart", "18", "Calibri");
