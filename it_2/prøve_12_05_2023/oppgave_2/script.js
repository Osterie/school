...
class Organisation{
    ...
    add_member(member){
        ...
        //fungerer ikke, men jeg vet ikke hvorfor
...
function winInit() {
    ...
    const orchestra_member1 = new MusicMember("Adrian", "Bjørge", "999 88 999", "adrian@mail.com", "fiolin")
    const orchestra_member2 = new MusicMember("Joa", "nordal", "999 88 999", "test@mail.com", "harpe")
    const orchestra_member3 = new MusicMember("Tobias", "sørdal", "777 88 777", "test@mail.com", "piano")
    const orchestra_member4 = new MusicMember("Antonio", "vestdal", "666 88 666", "test@mail.com", "fiolin")
    const orchestra_member5 = new MusicMember("Benni", "østdal", "444 88 444", "test@mail.com", "piano|")
